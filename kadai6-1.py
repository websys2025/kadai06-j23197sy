...
APP_ID = "7cc2a38b5373b821694e01d94fd3882177ab3401"
API_URL  = "https://api.e-stat.go.jp/rest/3.0/app/json/getStatsData" #エンドポイント


params = {
    "appId": APP_ID,
    "statsDataId":"0003287301", #火災統計 火災報告
    "metaGetFlg":"Y",           #メタ情報の取得
    "cntGetFlg":"N",            #件数の取得 無し
    "explanationGetFlg":"Y",    #統計表説明の取得
    "annotationGetFlg":"Y",     #注釈情報の取得
    "sectionHeaderFlg":"1",     #セクションヘッダを取得
    "replaceSpChars":"0",       #特殊文字の置換 無し
    "lang": "J"                 #日本語を指定
}
